...
namespace UnityEngine.Experimental.Rendering
{
	public enum GraphicsFormat
	{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Obsolete("Enum member GraphicsFormat.RGB_DXT1_SRGB has been deprecated. Use GraphicsFormat.RGBA_DXT1_SRGB instead (UnityUpgradable) -> RGBA_DXT1_SRGB", true)]
		RGB_DXT1_SRGB = 96,
		RGBA_DXT1_SRGB = 96,
		[EditorBrowsable(EditorBrowsableState.Never), Obsolete("Enum member GraphicsFormat.RGB_DXT1_UNorm has been deprecated. Use GraphicsFormat.RGBA_DXT1_UNorm instead (UnityUpgradable) -> RGBA_DXT1_UNorm", true)]
		RGB_DXT1_UNorm,
		RGBA_DXT1_UNorm = 97,
		RGBA_DXT3_SRGB,
		RGBA_DXT3_UNorm,
