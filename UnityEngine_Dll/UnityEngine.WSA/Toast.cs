...
{
	[NativeConditional("PLATFORM_WINRT"), NativeHeader("Runtime/Export/WSA/WSATiles.bindings.h"), StaticAccessor("WSATilesBindings::Toast", StaticAccessorType.DoubleColon)]
