...
{
	[NativeHeader("Runtime/Math/Rect.h"), NativeClass("Rectf", "template<typename T> class RectT; typedef RectT<float> Rectf;"), RequiredByNativeCode(Optional = true, GenerateProxy = true)]
