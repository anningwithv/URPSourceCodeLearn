...
{
	[NativeHeader("Modules/Animation/Constraints/LookAtConstraint.h"), NativeHeader("Modules/Animation/Constraints/Constraint.bindings.h"), RequireComponent(typeof(Transform)), UsedByNativeCode]
