...
{
	[NativeHeader("Modules/Animation/Constraints/ScaleConstraint.h"), NativeHeader("Modules/Animation/Constraints/Constraint.bindings.h"), RequireComponent(typeof(Transform)), UsedByNativeCode]
